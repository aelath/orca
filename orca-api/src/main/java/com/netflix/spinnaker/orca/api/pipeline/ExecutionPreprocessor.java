...
/**
 * ExecutionPreprocessor is a hook point that can modify an Execution upon initial receipt
 * of the configuration.
 *
 * <p>A common use case is to inspect and update a pipeline with configured context, such
 * an application name.
 */
